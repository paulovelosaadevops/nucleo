...
export interface CreateFinancialCardPurchaseRequest { creditCardId: string; categoryId: string | null; description: string; totalAmount: number; purchaseDate: string; totalInstallments: number; notes: string | null; }
export interface UpdateFinancialCardPurchaseRequest { categoryId: string | null; description: string; notes: string | null; }
export interface FinancialCreditCardInstallment { id: string; purchaseId: string; purchaseDescription: string; categoryId: string | null; categoryName: string | null; installmentNumber: number; totalInstallments: number; amount: number; status: FinancialCreditCardInstallmentStatus; paid: boolean; invoiceId: string; invoiceReferenceMonth: string; invoiceDueDate: string; }
export interface FinancialCreditCardPurchase { id: string; creditCardId: string; creditCardName: string; categoryId: string | null; categoryName: string | null; recurrenceId: string | null; recurrenceSequence: number | null; description: string; totalAmount: number; purchaseDate: string; totalInstallments: number; status: FinancialCreditCardPurchaseStatus; notes: string | null; createdByName: string; installments: FinancialCreditCardInstallment[]; createdAt: string; updatedAt: string; }
