export type FinancialTransactionType = "INCOME" | "EXPENSE" | "TRANSFER_IN" | "TRANSFER_OUT";
...
export type FinancialRecurrenceOccurrenceStatus = "AWAITING_CONFIRMATION" | "CONFIRMED" | "SKIPPED" | "OVERDUE" | "CANCELLED";
...
export interface FinancialRecurrenceOccurrence { id: string; recurrenceId: string; description: string; type: FinancialTransactionType; paymentMethod: FinancialPaymentMethod | null; accountId: string | null; accountName: string | null; creditCardId: string | null; creditCardName: string | null; categoryId: string | null; categoryName: string | null; referenceMonth: string; scheduledDate: string; reminderDate: string | null; status: FinancialRecurrenceOccurrenceStatus; estimatedAmount: number; confirmedAmount: number | null; expectedAmount: number; actualAmount: number; confirmedDate: string | null; transactionId: string | null; purchaseId: string | null; notes: string | null; confirmedByUserId: string | null; confirmedByName: string | null; confirmedAt: string | null; createdAt: string; updatedAt: string; }
export interface ConfirmFinancialRecurrenceOccurrenceRequest { amount: number; chargedDate: string; categoryId: string | null; accountId: string | null; creditCardId: string | null; paymentMethod: FinancialPaymentMethod | null; notes: string | null; }
export interface SkipFinancialRecurrenceOccurrenceRequest { notes: string | null; }
export interface PostponeFinancialRecurrenceOccurrenceRequest { reminderDate: string; }
